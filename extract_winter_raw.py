...
# Create output directory for winter frames (raw, no background removal)
output_dir = "winter_frames_raw"
os.makedirs(output_dir, exist_ok=True)

print("Extracting frames from winter fairy video (no background removal)...")
