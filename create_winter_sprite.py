...
# Directory containing winter frames
...
print("Creating winter fairy sprite sheet...")
...
# Save sprite sheet as PNG (replacing the current fairy-sprite.png)
...
print(f"\nOriginal fairy backed up to: fairy-sprite-original.png")
